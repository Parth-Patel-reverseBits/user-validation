...
const addingDataOnTable = (array) => {
  ...
  for (let data of array) {
    ...
    </svg> </span> <span data-bs-toggle="modal" data-bs-target='#deleteModal' style='cursor: pointer;'> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
