...
const addUserData = () => {
  ...
  addUserObj["userId"] = document.getElementById("add-name").value;
  addUserObj["id"] = document.getElementById("add-text").value;
  addUserObj["title"] = document.getElementById("add-title").value;
  addUserObj["body"] = document.getElementById("add-body").value;

  clonedArray.unshift(addUserObj);
...
const deleteModelButton = () => {
  ...
  if (isObject(deleteRecordId)) {
    document.getElementById(deleteRecordId.id).remove();
  } else {
    document.getElementById(deleteRecordId).remove();
  }
};
